...
const mockInternship: InternshipFormData = {
...
export default function EditInternshipPage() {
  ...
  useEffect(() => {
    // Simulate API call to fetch internship data
    const fetchInternship = async () => {
      await new Promise((resolve) => setTimeout(resolve, 500));
      setFormData(mockInternship);
      setIsLoading(false);
    };
      ...
      <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-[14px] text-[#6A7287]">
            The internship you're trying to edit doesn't exist.
          </p>
        </div>
      </div>
    );
                  ...
                  {[
                    ...
                    return (
                      <button
                        ...
                        onClick={() =>
                          setFormData((prev) =>
                            prev ? { ...prev, workMode: mode.value as WorkMode } : null
                          )
                        }
