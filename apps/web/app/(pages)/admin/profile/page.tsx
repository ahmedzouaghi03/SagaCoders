              ...
              <div className="space-y-6">
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <span className="px-2 py-0.5 bg-[#3D5EE1]/10 text-[#3D5EE1] text-[12px] font-medium rounded-full capitalize">
                      {profile.role}
                    </span>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-10 h-10 rounded-lg bg-[#F4F6FA] flex items-center justify-center flex-shrink-0">
                      <Shield className="w-5 h-5 text-[#6A7287]" />
                    </div>
                    <div>
                      <p className="text-[12px] text-[#6A7287] mb-0.5">Role</p>
                      <p className="text-[14px] font-medium text-[#202C4B] capitalize">
                        {profile.role}
                      </p>
                    </div>
                  </div>
