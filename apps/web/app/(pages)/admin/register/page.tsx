// filepath: c:\Users\MSI\Desktop\ahmed\projects\SagaCoders\apps\web\app\(pages)\admin\register\page.tsx
"use client";
      ...
      <div className="hidden lg:block lg:w-1/2 relative">
        ...
        <div className="absolute inset-0 flex flex-col justify-center px-12 xl:px-20">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-md">
            Access powerful tools to oversee students, companies, and internship programs. 
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-white/70 text-sm">Manage all platform users efficiently</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-white/70 text-sm">Customize platform settings</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="p-5 flex flex-col gap-4">
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                ...
                <p className="text-center text-sm text-[#202C4B] font-roboto">
                  ...
                  <Link href="/admin/login" className="text-[#3D5EE1] hover:underline font-medium">
                    Sign In
                  </Link>
                </p>
              </form>
